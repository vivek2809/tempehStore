...
export default function Header() {
  ...
  const message = {
    ...
    no: "Minimum bestilling produkter gratis 50€",
  };
  ...
  const navItems = {
    en: {
      tempeh: "TERRANEAN TEMPEH",
      shop: "SHOP",
      recipes: "RECIPES",
      foodservice: "MEAL SERVICE",
      findUs: "FIND US",
      b2b: "B2B",
      about: "ABOUT US",
      vss: "VSS",
      wellness: "WELLNESS", // icon with meditating person
      cart: "CART", // shopping bag icon
      lang: "NO", // language selector
    },
    no: {
      // Norwegian version
      tempeh: "TERRANEAN TEMPEH",
      shop: "BUTIKK",
      recipes: "OPPSKRIFTER",
      foodservice: "MATSERVICE",
      findUs: "FINN OSS",
      b2b: "B2B",
      about: "OM OSS",
      vss: "VSS",
      wellness: "VELVÆRE", // meditating person → wellness
      cart: "HANDLEKURV", // shopping bag
      lang: "NO", // language selector
    },
  };
  ...
  return (
    <>
      ...
      <div
        style={{ backgroundColor: "rgba(169,185,172,0.8)" }}
        className="text-gray-800 text-sm py-2 overflow-hidden w-full"
      >
        <div className="w-full">
          <div className="flex justify-end items-center px-4 sm:px-8 relative">
            {/* Empty left space */}
          ...
          <div className="flex justify-between items-center md:justify-center h-16 relative">
            ...
            >
              <i
                ...
                }-line w-6 h-6 flex items-center justify-center`}
              ></i>
            </button>
            ...
            >
              <div className="font-['Pacifico'] text-2xl sm:text-3xl text-gray-800 flex items-center">
                <div
                  className="w-6 h-6 sm:w-8 sm:h-8 rounded-full mr-2 flex items-center justify-center"
                  style={{ backgroundColor: "rgba(169,185,172,0.8)" }}
                >
            ...
            <Link
              href="/shop"
              className="md:hidden p-2 text-gray-800 hover:text-gray-600 rounded-md transition-all order-3"
            >
          ...
          <nav className="hidden md:block mt-4 border-t border-gray-200 pt-4">
            <div className="flex justify-center">
              <div className="flex items-center space-x-6 lg:space-x-8 text-sm font-medium">
                <Link
                  href="/nordic-tempeh"
                  className="text-gray-800 hover:text-gray-600 px-3 py-2 rounded-md transition-all whitespace-nowrap"
                >
                ...
                <Link
                  ...
                  className="text-gray-800 hover:text-gray-600 px-3 py-2 rounded-md transition-all whitespace-nowrap"
                >
                  {navItems[language].foodservice}
                </Link>
                <Link
                  href="/reviews"
                  className="text-gray-800 hover:text-gray-600 px-3 py-2 rounded-md transition-all whitespace-nowrap"
                >
                  {navItems[language].findUs}
                </Link>
                <Link
                  href="/"
                  className="text-gray-800 hover:text-gray-600 px-3 py-2 rounded-md transition-all whitespace-nowrap"
                >
                  {navItems[language].b2b}
                </Link>
                <Link
                  href="/about"
                  className="text-gray-800 hover:text-gray-600 px-3 py-2 rounded-md transition-all whitespace-nowrap"
                ...
                >
                  {language.toUpperCase()} / {language === "en" ? "NO" : "EN"}
                </button>

                {/* Cart Icon */}
                <Link
                  href="/shop"
                  className="p-2 text-gray-800 hover:text-gray-600 rounded-md transition-all"
                >
                  <i className="ri-shopping-cart-line w-5 h-5 flex items-center justify-center"></i>
                </Link>
              </div>
              ...
              <nav className="p-4 space-y-1">
                ...
                <div className="pt-4 border-t border-gray-200 mt-4">
                  ...
                  >
                    ...
                    {language.toUpperCase()} / {language === "no" ? "EN" : "NO"}
                  </button>
                </div>
              </nav>
            </div>
